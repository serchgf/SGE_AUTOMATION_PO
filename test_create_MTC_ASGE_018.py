...
class SgePoUnittest(unittest.TestCase):
    ...
    def test_MTC_ASGE_018(self):

        #print("Test using: "+supplier)
        sge_funct = sge_functions2()
        print("------------------------------Recibida Internacional")

        """TC17 ESTE TEST CASE NECESITA PO CON STATUS 'RECIBIDA EN ORIGEN(10)' """
        ...
        if conectado:
            ...
            num_po_seleccionada, inv_po_seleccionada, psc_select_txt = sge_funct.obtener_datos_psc_file(
                files.internacionales_revisada_en_origen_10_folder)
            # num_po
...
# --------------------borrar
            ...
            if sge_funct.validar_po_status2(img_status, nombre_status_esperado):
                ...
                print(" Generando PO  PSC STATUS 11")
                num_status = "11"
                path_destino = files.internacionales_recibida_11_folder
                ...
                if conectado:
                    ...
                    sge_funct.press_enter()
                    # cual es ese archivo?
                    print("3 Ingresar archivo de cambios de estatus PSC ESTATUS 11")
                    sge_funct.subir_po_sftp_internacional_por_psc_txt(files.internacionales_recibida_11_folder, psc_select_txt)
                    ...
                    print("Ingresar archivo de cambios de estatus PSC ESTATUS 11")
                    ...
                    if job_status_correcto:
                        ...
                        # copiar psc utilizada  en status 11 para reporte
                    ...
                    # ____________________________________________BLOQUE SGE ADM EJECUTAR JOB
                        ...
                        if conectado:
                            ...
                            print("Validating Purchase Order")
                            nombre_status_esperado = "RECIBIDA POR AGTE AD"
                            #OBTENER IMAGEN RECIBIDA POR AGTE AD
                            img_status = images.img_status_recibida_por_agte_ad
                            if sge_funct.validar_po_status2(img_status, nombre_status_esperado):
                                print(f"Status {nombre_status_esperado} validado correctamente")
                               # eliminar PSC status 10
