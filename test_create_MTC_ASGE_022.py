...
class SgePoUnittest(unittest.TestCase):
    ...
    def test_MTC_ASGE_022(self):

        #print("Test using: "+supplier)
        sge_funct = sge_functions2()
        print("------------------------------Pedimento Pagado Internacional")

        """TC22 ESTE TEST CASE NECESITA PO CON STATUS 'EN PROCESO DE CRUCE (14)' """
        ...
        if conectado:
            ...
            if sge_funct.validar_po_status2(img_status, nombre_status_esperado):
                ...
                # print(" Generando PO  PSC STATUS 15")
                # num_status = "15"
                ...
                if conectado:
                    ...
                    print("Ingresar archivo de pedimento MUP")
                    print("8 Ejecutar JOB PEDIMENTO bash procesa_EDI.sh 'REC_REQUEST_FORM'")
                    ...
                    if job_status_correcto:
                        ...
                        if conectado:
                            ...
                            # # OBTENER IMAGEN EN CRUZADA POR AGTE ADU
