...
class SgePoUnittest(unittest.TestCase):
    ...
    def test_MTC_ASGE_023(self):

        #print("Test using: "+supplier)
        sge_funct = sge_functions2()
        print("------------------------------En Transito Nacional Internacional")

        """TC23 ESTE TEST CASE NECESITA PO CON STATUS 'CRUZADA (15)' """
        ...
        if conectado:
            ...
            num_po_seleccionada, inv_po_seleccionada, psc_select_txt = sge_funct.obtener_datos_psc_file(
                files.internacionales_cruzada_15_folder)
            # num_po
            ...
            # print("Validating Purchase Order")
            # nombre_status_esperado = "CRUZADA POR AGTE ADU"
            # #OBTENER IMAGEN
            ...
            # CAMBIAR IMAGEN EN CRUCE POR AGTE AD
            ...
            if sge_funct.validar_po_status2(img_status, nombre_status_esperado):
                ...
                #### GENERAR MUP
                # CREAR FUNCION PARA MODIFICAR ARCHIVO MUP
                # MUP TIENE 14 COLUMNAS, SE DEBE EDITAR LA LINEA 1 EN LAS COLUMNAS ?? A DEFINIR

                print(" Generando PO  PSC STATUS 16")
                num_status = "16"
                # CREAR NUEVA FUNCION PARA PODER MODIFICAR EL LA COLUMNA 2 [SUBDIVISION
                path_destino = files.internacionales_en_transito_nacional_16
                ...
                if conectado:
                    ...
                    sge_funct.press_enter()
                    # SUBIR MUP modificar esta parte
                    print("3 Ingresar archivo de cambios de estatus PSC ESTATUS 16")
                    sge_funct.subir_po_sftp_internacional_por_psc_txt(
                    ...
                    print("8 Ejecutar JOB STATUS CHANGE bash procesa_EDI.sh 'REC_REQUEST_FORM'")
                    sge_funct.send_text("bash procesa_EDI.sh REC_REQUEST_FORM")
                    ...
                    if job_status_correcto:
                        ...
                        if conectado:
                            ...
                            print("Validating Purchase Order")
                            # nombre_status_esperado = "EN TRANSITO DESDE AG" # es el mismo status que el anterior?
                            # # OBTENER IMAGEN EN TRANSITO DESDE AG
