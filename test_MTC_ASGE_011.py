...
class SgePoUnittest(unittest.TestCase):
    ...
    def test_PurchaseOrder_Confirmacion_Internacional_SINDSO(self):
        """TC_11  """
        print("------------------------------Test to Create PurchaseOrder_Confirmacion_Internacional_SINDSO")
        ...
        if conectado:
            ...
            print("3 Ingresar archivo de cambios de estatus PSC")
            num_po_seleccionada, inv_po_seleccionada, random_po_txt = sge_funct.subir_po_sftp_internacional(files.internacionales_por_confirmar_03_SINDSO_folder)
            print(f"psc seleccionado: {random_po_txt}")
            ...
            print("8 Ejecutar JOB STATUS CHANGES bash procesa_EDI.sh REC_ESTATUS_TXT")
            ...
            if job_status_correcto:
                ...
                if conectado:
                    ...
                    #num_po_seleccionada = "012A0021200343RD"
                    ...
                    if sge_funct.validar_po_status2(img_status, nombre_status_esperado):
                        ...
                        print("Creando facturas internacionales valida e invalida")
                        sge_funct.crear_factura_valida_e_invalida_internacional_txt(num_po_seleccionada)
                        print("MOVER po de 'facturas_internacionales/por_confirmar_03_SINDSO' a 'facturas_internacionales/confirmada_03_SINDSO'")
                        directorio_origen = files.internacionales_por_confirmar_03_SINDSO_folder
                        directorio_destino = files.internacionales_confirmada_03_SINDSO_folder
