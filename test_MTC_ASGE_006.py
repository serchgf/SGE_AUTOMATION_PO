...
class SgePoUnittest(unittest.TestCase):
    ...
    def test_PurchaseOrder_RecibidaRevision_Nacional(self):
        ...
        if conectado:
            ...
            num_factura_en_transito, inv_factura_en_transito, nombre_archivo = sge_funct.obtener_factura_de_directorio(files.inv_en_transito_folder)
            ...
            if sge_funct.validar_po_status2(img_status, nombre_status):
                ...
                directorio_origen = files.inv_en_transito_folder
                directorio_destino = files.inv_recibida_en_revision_folder
                sge_funct.mover_facturas(num_factura_en_transito, directorio_origen, directorio_destino)
            else:
