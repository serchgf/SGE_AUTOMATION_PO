...
class SgePoUnittest(unittest.TestCase):
    ...
    def test_PurchaseOrder_AcomodadoPendienteEntrada_Nacional(self):
        ...
        if conectado:
            ...
            sge_funct.send_text(num_factura_recibida_en_proceso_de_acomodo)
            ...
            if sge_funct.validar_po_status2(img_status, nombre_status_esperado):
                ...
                sge_funct.mover_facturas(num_factura_recibida_en_proceso_de_acomodo, files.inv_en_proceso_de_acomodo_folder, files.inv_acomodado_pendiente_de_entrada_folder)
            else:
