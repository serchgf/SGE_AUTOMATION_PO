    ...
    def test_PurchaseOrder_ProcesodeAcomodo_Nacional(self):
        ...
        if conectado:
            ...
            if sge_funct.validar_po_status2(img_status, nombre_status):
                ...
                directorio_origen = files.inv_recibida_en_revision_folder
                directorio_destino = files.inv_en_proceso_de_acomodo_folder
                sge_funct.mover_facturas(num_factura_en_proceso_de_revision, directorio_origen, directorio_destino)
            else:
