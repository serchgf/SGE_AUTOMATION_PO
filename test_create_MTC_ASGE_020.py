...
class SgePoUnittest(unittest.TestCase):
    ...
    def test_MTC_ASGE_020(self):

        #print("Test using: "+supplier)
        sge_funct = sge_functions2()
        print("------------------------------Revisada Agente Aduanal Internacional")

        """TC20 ESTE TEST CASE NECESITA PO CON STATUS 'REVISADA (12)' """
        ...
        if conectado:
            ...
            if sge_funct.validar_po_status2(img_status, nombre_status_esperado):
                ...
                print(" Generando PO  PSC STATUS 13")
                num_status = "13"
                path_destino = files.internacionales_pedimento_pagado_13_folder
                ...
                if conectado:
                    ...
                    sge_funct.press_enter()
                    # cual es ese archivo?
                    print("3 Ingresar archivo de cambios de estatus PSC ESTATUS 13")
                    sge_funct.subir_po_sftp_internacional_por_psc_txt(files.internacionales_pedimento_pagado_13_folder,
                                                                      psc_select_txt)
                    ...
                    if job_status_correcto:
                        ...
                        # copiar psc utilizada  en status 13 para reporte
                        ...
                        if conectado:
                            ...
                            print("Validating Purchase Order")
                            nombre_status_esperado = "PEDIMENTO PAGADO"
                            # OBTENER IMAGEN PEDIMENTO PAGADO
                            img_status = images.img_status_pedimento_pagado
                            if sge_funct.validar_po_status2(img_status, nombre_status_esperado):
                                print(f"Status {nombre_status_esperado} validado correctamente")
                                # eliminar PSC status 12
                                print("eliminando psc procesada status 12...")
                                path_archivo_origen = files.internacionales_revisada_12_folder
                                sge_funct.remove_file(path_archivo_origen, psc_select_txt)
